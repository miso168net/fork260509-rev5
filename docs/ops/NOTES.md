...
- **其餘在案候選**：B-008 餘兩張 view（＋audit 5 端點；豁免表到期即紅）；B-124（①在本批）／B-125／B-131～B-133；
  兩筆待補：B-035 雙平台 DoD 之 macOS 側、setup-reaper 正向 ALTER ROLE 待建 reaper role 之刀；帶 migration 的刀沿用
  001 紀律（收刀前 refresh＋演進帳登記＋三閘綠，RUNBOOK §10）。★另六條已滯後（查全帳須併看 BACKLOG-DEFERRED.md）；
...
- **★進行中＝下一刀起手維護批**（輕量軌、拍板 2026-08-30、自 default f1c0951 開出）：四條 docs-sync 條款面＋B-124①。
  ...
  RUNBOOK §12.1 瘦身、本檔已收官段刪除）；餘 B-146／B-147／B-148＋B-124① 依序編排。
