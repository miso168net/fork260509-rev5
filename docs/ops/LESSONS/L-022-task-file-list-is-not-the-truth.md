---
promoted_to: CLAUDE.md §2 防呆⑥（清單答「碰得到什麼」而非 task 寫了什麼、對實碼查、寧可多列＝防法①半②）＋§2 單元收尾⑥已載（啟下一支派發前對其 tasks 逐條問「它 import／呼叫／宣告的東西存在嗎」＋不存在就往前追是誰該建＝派工單缺口＋agent 回 blocked 先判允許清單有無缺口＝防法①全＋④；2026-08-31 維護批 W2）；防法③「撞到就回頭修 tasks.md」屬單元邊界動作、由本條 hook 承載
---
