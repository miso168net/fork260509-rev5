---
promoted_to: CLAUDE.md §2 防呆⑥（2026-08-30 B-091 盤點補句：清單答「碰得到什麼」而非 task 寫了什麼、對實碼查、寧可多列＝防法①（半：「現在存在嗎」之實碼查已載、「往前追是誰該建＝派工單缺口」未載）②；防法③「撞到就回頭修 tasks.md」屬單元邊界動作、由本條 hook 承載；防法④「agent 回 blocked 先判自己清單有無缺口」為主線側判讀句、⑥現行只載 implementer 側義務＝未載，候選位＝§2 防呆⑥或單元收尾①、本單元 ⑥ 之一句預算已用、待下一把動該段的刀）
---
